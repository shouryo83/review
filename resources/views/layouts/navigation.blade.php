<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 mx-auto">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('spotify.redirect')" :active="request()->routeIs('spotify.redirect')">
                {{ '過去の出演者' }}
            </x-responsive-nav-link>
        </div>
